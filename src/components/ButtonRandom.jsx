...
export default function ButtonRandom() {
    ...
    return(
        <div className="my-6 pb-6 py-10 ring-1 ring-slate-900/10 rounded-lg shadow-lg">
            <h3 className="text-slate-900 text-base font-medium mb-10">Random Word Generator:</h3>
            <div className="text-slate-500 dark:text-slate-400 mt-2 text-xs">
                <div className="relative">
                    <div className="ring-1 rounded-full">
                        <h2 id="display-result" className="py-5 justify-center text-dark text-bold">
                            {randomNoun}
                        </h2>
                    </div>
                    <br />
                    <button>
                        <div className="bg-red-500 text-white py-1 px-2 rounded-full mx-1">
                            Noun
                        </div>
                    </button>
                    <button>
                        <div className="bg-green-500 text-white py-1 px-2 rounded-full mx-1">
                        Plural Noun
                        </div>
                    </button>
                    <button>
                        <div className="bg-purple-500 text-white py-1 px-2 rounded-full mx-1">
                            Verb
                        </div>
                    </button>
                    <button>
                        <div className="bg-blue-500 text-white py-1 px-2 rounded-full mx-1">
                            Verb-ING
                        </div>
                    </button>
