                        ...
                        <div key={index} className="md:grid md:grid-cols-3 md:gap-6">
                            <div className="md:col-span-1">
                                <div className="px-4 sm:px-0">
                                    <h2 className="text-lg font-medium leading-6 text-gray-900">Family Rock Judge</h2>
                            ...
                            <div className="mt-5 md:col-span-2 md:mt-0">
                                <div className="overflow-hidden shadow sm:rounded-md">
                                    <div className="bg-white px-4 py-5 sm:p-6">
                                        <p>
                                            When it was my turn to audition for <strong>{oneMadLib.noun}</strong> Idol, the reality show where people compete to be the best solo <strong>{oneMadLib.noun2}</strong>, 
                                            I sang from the depths of my very <strong>{oneMadLib.bodyPart}</strong>....
                                        </p>
